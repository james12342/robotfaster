...
namespace taskt.Core
{
    public static class Common
    {
        ...
        public static List<Core.Script.ScriptVariable> GenerateSystemVariables()
        {
            ...
            systemVariableList.Add(new Core.Script.ScriptVariable { VariableName = "DateTime.Now.Date(yyyy-MM-dd)", VariableValue = DateTime.Now.ToString("yyyy-MM-dd")});
            systemVariableList.Add(new Core.Script.ScriptVariable { VariableName = "The End Date of this Month", VariableValue = new DateTime(DateTime.Now.Year, DateTime.Now.Month,DateTime.DaysInMonth(DateTime.Now.Year, DateTime.Now.Month)).ToString("yyyy-MM-dd") });
            ...
            systemVariableList.Add(new Core.Script.ScriptVariable { VariableName = "Char.-", VariableValue = "-" });
